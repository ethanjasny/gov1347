...
author: "[Ethan Jasny](https://twitter.com/EthanJasny)"
date: '2022-09-09'
slug: []
categories: []
tags: []
...
```
There are a few important observations to make based on these maps. First, note that the Republican share of the vote is the exact inverse of the Democratic share of the vote. This is because we are dealing with the **two-party** vote share:

$$  

R_{vote-share} = \frac{R_{vote}}{R_{vote}+D_{vote}} = 1 - \frac{D_{vote}}{R_{vote}+D_{vote}} = 1 - D_{vote-share}
