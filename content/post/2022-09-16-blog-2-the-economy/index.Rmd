...
model_midterm <- lm(incumbent_pres_majorvote ~ midterm_dummy, data = model_1_data)

summary(model_midterm)
...
```{r}
## Model 1: The Incumbency-Midterm Model

sqrt(mean((lm_RDI_vote$model$incumbent_pres_majorvote - lm_RDI_vote$fitted.values)^2))
mean(lm_RDI_vote$model$incumbent_pres_majorvote - lm_RDI_vote$fitted.values)
mean(abs(lm_RDI_vote$model$incumbent_pres_majorvote - lm_RDI_vote$fitted.values))
```
