...
There are a few important observations to make based on these maps. First, note that the Republican share of the vote is the exact inverse of the Democratic share of the vote. This is because we are dealing with the **two-party** vote share: Republican vote share is thus equivalent to one minus the Democratic vote share 9and vice-versa)
